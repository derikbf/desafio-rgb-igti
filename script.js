...
function mapElements() {
  ...
  inputRangeRed.addEventListener('change', handleInputRangeChance);
  inputRangeGreen.addEventListener('change', handleInputRangeChance);
  inputRangeBlue.addEventListener('change', handleInputRangeChance);
}

function handleInputRangeChance(event) {
